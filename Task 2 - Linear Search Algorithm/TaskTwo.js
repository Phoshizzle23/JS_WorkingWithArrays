...
function findAthletePosition(name) {
  // Use sequential search to find the position of the athlete in the array
...
function removeAthlete(name) {
  // Find the position of the athlete in the array
  const index = findAthletePosition(name);
  ...
  // Remove the athlete's name and height from the arrays
